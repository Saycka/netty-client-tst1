...
import time.client.goodsolution.TimeClientHandler2;
import time.client.goodsolution.TimeDecoder2;
...
//      because the client-side SocketChannel does not have a parent.
      ...
      bootstrap.handler(new ChannelInitializer<SocketChannel>() {
        protected void initChannel(SocketChannel socketChannel) throws Exception {
          socketChannel.pipeline().addLast(new TimeDecoder3(), new TimeClientHandler3()); //different
        }
      });
